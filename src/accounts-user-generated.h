...
#ifndef __ACCOUNTS_USER_GENERATED_H__
#define __ACCOUNTS_USER_GENERATED_H__
...
#define ACCOUNTS_USER_GET_IFACE(o) (G_TYPE_INSTANCE_GET_INTERFACE ((o), ACCOUNTS_TYPE_USER, AccountsUserIface))
...
struct _AccountsUserIface
{
  ...
  gboolean  (*get_local_account) (AccountsUser *object);
  ...
  GVariant * (*get_login_history) (AccountsUser *object);

  gint64  (*get_login_time) (AccountsUser *object);
...
void accounts_user_complete_set_password_hint (
    AccountsUser *object,
    GDBusMethodInvocation *invocation);
...
void accounts_user_call_set_password_hint (
    AccountsUser *proxy,
    const gchar *arg_hint,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
...
gboolean accounts_user_call_set_password_hint_finish (
    AccountsUser *proxy,
    GAsyncResult *res,
    GError **error);

gboolean accounts_user_call_set_password_hint_sync (
    AccountsUser *proxy,
    const gchar *arg_hint,
    GCancellable *cancellable,
    GError **error);
...
gint64 accounts_user_get_login_time (AccountsUser *object);
void accounts_user_set_login_time (AccountsUser *object, gint64 value);

GVariant *accounts_user_get_login_history (AccountsUser *object);
GVariant *accounts_user_dup_login_history (AccountsUser *object);
void accounts_user_set_login_history (AccountsUser *object, GVariant *value);
...
gboolean accounts_user_get_local_account (AccountsUser *object);
void accounts_user_set_local_account (AccountsUser *object, gboolean value);


/* ---- */

#define ACCOUNTS_TYPE_USER_PROXY (accounts_user_proxy_get_type ())
#define ACCOUNTS_USER_PROXY(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), ACCOUNTS_TYPE_USER_PROXY, AccountsUserProxy))
#define ACCOUNTS_USER_PROXY_CLASS(k) (G_TYPE_CHECK_CLASS_CAST ((k), ACCOUNTS_TYPE_USER_PROXY, AccountsUserProxyClass))
#define ACCOUNTS_USER_PROXY_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), ACCOUNTS_TYPE_USER_PROXY, AccountsUserProxyClass))
#define ACCOUNTS_IS_USER_PROXY(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), ACCOUNTS_TYPE_USER_PROXY))
#define ACCOUNTS_IS_USER_PROXY_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE ((k), ACCOUNTS_TYPE_USER_PROXY))
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC (AccountsUserProxy, g_object_unref)
#endif
...
#define ACCOUNTS_TYPE_USER_SKELETON (accounts_user_skeleton_get_type ())
#define ACCOUNTS_USER_SKELETON(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), ACCOUNTS_TYPE_USER_SKELETON, AccountsUserSkeleton))
#define ACCOUNTS_USER_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_CAST ((k), ACCOUNTS_TYPE_USER_SKELETON, AccountsUserSkeletonClass))
#define ACCOUNTS_USER_SKELETON_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), ACCOUNTS_TYPE_USER_SKELETON, AccountsUserSkeletonClass))
#define ACCOUNTS_IS_USER_SKELETON(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), ACCOUNTS_TYPE_USER_SKELETON))
#define ACCOUNTS_IS_USER_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE ((k), ACCOUNTS_TYPE_USER_SKELETON))
...
#if GLIB_CHECK_VERSION(2, 44, 0)
G_DEFINE_AUTOPTR_CLEANUP_FUNC (AccountsUserSkeleton, g_object_unref)
#endif
...
#endif /* __ACCOUNTS_USER_GENERATED_H__ */
