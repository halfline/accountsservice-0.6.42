...
#ifndef __CK_SEAT_GENERATED_H__
#define __CK_SEAT_GENERATED_H__
...
#define CONSOLE_KIT_TYPE_SEAT (console_kit_seat_get_type ())
#define CONSOLE_KIT_SEAT(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), CONSOLE_KIT_TYPE_SEAT, ConsoleKitSeat))
#define CONSOLE_KIT_IS_SEAT(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), CONSOLE_KIT_TYPE_SEAT))
#define CONSOLE_KIT_SEAT_GET_IFACE(o) (G_TYPE_INSTANCE_GET_INTERFACE ((o), CONSOLE_KIT_TYPE_SEAT, ConsoleKitSeatIface))
...
#define CONSOLE_KIT_TYPE_SEAT_PROXY (console_kit_seat_proxy_get_type ())
#define CONSOLE_KIT_SEAT_PROXY(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), CONSOLE_KIT_TYPE_SEAT_PROXY, ConsoleKitSeatProxy))
#define CONSOLE_KIT_SEAT_PROXY_CLASS(k) (G_TYPE_CHECK_CLASS_CAST ((k), CONSOLE_KIT_TYPE_SEAT_PROXY, ConsoleKitSeatProxyClass))
#define CONSOLE_KIT_SEAT_PROXY_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), CONSOLE_KIT_TYPE_SEAT_PROXY, ConsoleKitSeatProxyClass))
#define CONSOLE_KIT_IS_SEAT_PROXY(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), CONSOLE_KIT_TYPE_SEAT_PROXY))
#define CONSOLE_KIT_IS_SEAT_PROXY_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE ((k), CONSOLE_KIT_TYPE_SEAT_PROXY))
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC (ConsoleKitSeatProxy, g_object_unref)
#endif
...
#define CONSOLE_KIT_TYPE_SEAT_SKELETON (console_kit_seat_skeleton_get_type ())
#define CONSOLE_KIT_SEAT_SKELETON(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), CONSOLE_KIT_TYPE_SEAT_SKELETON, ConsoleKitSeatSkeleton))
#define CONSOLE_KIT_SEAT_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_CAST ((k), CONSOLE_KIT_TYPE_SEAT_SKELETON, ConsoleKitSeatSkeletonClass))
#define CONSOLE_KIT_SEAT_SKELETON_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), CONSOLE_KIT_TYPE_SEAT_SKELETON, ConsoleKitSeatSkeletonClass))
#define CONSOLE_KIT_IS_SEAT_SKELETON(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), CONSOLE_KIT_TYPE_SEAT_SKELETON))
#define CONSOLE_KIT_IS_SEAT_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE ((k), CONSOLE_KIT_TYPE_SEAT_SKELETON))
...
#if GLIB_CHECK_VERSION(2, 44, 0)
G_DEFINE_AUTOPTR_CLEANUP_FUNC (ConsoleKitSeatSkeleton, g_object_unref)
#endif
