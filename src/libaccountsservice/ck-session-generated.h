...
#ifndef __CK_SESSION_GENERATED_H__
#define __CK_SESSION_GENERATED_H__
...
#define CONSOLE_KIT_SESSION(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), CONSOLE_KIT_TYPE_SESSION, ConsoleKitSession))
#define CONSOLE_KIT_IS_SESSION(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), CONSOLE_KIT_TYPE_SESSION))
#define CONSOLE_KIT_SESSION_GET_IFACE(o) (G_TYPE_INSTANCE_GET_INTERFACE ((o), CONSOLE_KIT_TYPE_SESSION, ConsoleKitSessionIface))
...
#define CONSOLE_KIT_TYPE_SESSION_PROXY (console_kit_session_proxy_get_type ())
#define CONSOLE_KIT_SESSION_PROXY(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), CONSOLE_KIT_TYPE_SESSION_PROXY, ConsoleKitSessionProxy))
#define CONSOLE_KIT_SESSION_PROXY_CLASS(k) (G_TYPE_CHECK_CLASS_CAST ((k), CONSOLE_KIT_TYPE_SESSION_PROXY, ConsoleKitSessionProxyClass))
#define CONSOLE_KIT_SESSION_PROXY_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), CONSOLE_KIT_TYPE_SESSION_PROXY, ConsoleKitSessionProxyClass))
#define CONSOLE_KIT_IS_SESSION_PROXY(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), CONSOLE_KIT_TYPE_SESSION_PROXY))
#define CONSOLE_KIT_IS_SESSION_PROXY_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE ((k), CONSOLE_KIT_TYPE_SESSION_PROXY))
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC (ConsoleKitSessionProxy, g_object_unref)
#endif
...
#define CONSOLE_KIT_TYPE_SESSION_SKELETON (console_kit_session_skeleton_get_type ())
#define CONSOLE_KIT_SESSION_SKELETON(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), CONSOLE_KIT_TYPE_SESSION_SKELETON, ConsoleKitSessionSkeleton))
#define CONSOLE_KIT_SESSION_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_CAST ((k), CONSOLE_KIT_TYPE_SESSION_SKELETON, ConsoleKitSessionSkeletonClass))
#define CONSOLE_KIT_SESSION_SKELETON_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), CONSOLE_KIT_TYPE_SESSION_SKELETON, ConsoleKitSessionSkeletonClass))
#define CONSOLE_KIT_IS_SESSION_SKELETON(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), CONSOLE_KIT_TYPE_SESSION_SKELETON))
#define CONSOLE_KIT_IS_SESSION_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE ((k), CONSOLE_KIT_TYPE_SESSION_SKELETON))
...
#if GLIB_CHECK_VERSION(2, 44, 0)
G_DEFINE_AUTOPTR_CLEANUP_FUNC (ConsoleKitSessionSkeleton, g_object_unref)
#endif
...
#endif /* __CK_SESSION_GENERATED_H__ */
